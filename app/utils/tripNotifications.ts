...
export async function requestNotificationPermissions(): Promise<boolean> {
    // TEMPORARILY DISABLED: expo-notifications removed from Expo Go SDK 53
    console.log('[Notifications] Disabled in Expo Go SDK 53 - use development build');
    return false;
    // try {
...
export async function scheduleReservationReminders(reservation: Reservation): Promise<void> {
    // TEMPORARILY DISABLED: expo-notifications removed from Expo Go SDK 53
    console.log('[Notifications] Disabled - use development build for push notifications');
    return;
    // try {
    //     // Verificar permisos
...
export async function cancelReservationReminders(reservationId: string): Promise<void> {
    ...
    console.log('[Notifications] Disabled - cancel reminders not available');
    return;
    // try {
...
export async function sendImmediateNotification(
    ...
    // TEMPORARILY DISABLED
    console.log('[Notifications] Disabled - immediate notification not available');
    return;
    // try {
    //     const hasPermission = await requestNotificationPermissions();
...
export async function clearAllNotifications(): Promise<void> {
    // TEMPORARILY DISABLED
    console.log('[Notifications] Disabled - clear notifications not available');
    return;
    // try {
...
export async function getScheduledNotifications(): Promise<any[]> {
    // TEMPORARILY DISABLED
    console.log('[Notifications] Disabled - get scheduled notifications not available');
    return [];
    // try {
