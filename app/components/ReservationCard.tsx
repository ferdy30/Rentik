...
function ReservationCard({
  ...
  const formatTimeFromISO = (
    ...
    if (fallbackDate) {
      return fallbackDate.toLocaleTimeString("es-ES", {
        hour: "2-digit",
        minute: "2-digit",
      });
    }
  ...
  const address =
    reservation.deliveryAddress || reservation.pickupLocation || "Ubicación";
  ...
  return (
    <Animated.View style={[styles.card, { transform: [{ scale: scaleAnim }] }]}>
          ...
          {isUrgent &&
            ...
            !isStartingSoon && (
              <View style={styles.soonBadge}>
                ...
                >{`En ${daysUntilStart} días`}</Text>
              </View>
            )}

          {/* Vehicle Title on Image */}
          <View style={styles.vehicleInfoOverlay}>
            <Text style={styles.vehicleNameOverlay} numberOfLines={1}>
              {vehicleName}
            </Text>
      ...
      <View style={styles.contentSection}>
        ...
        {/* Extras */}
        {reservation.extras &&
          Object.values(reservation.extras).some((v) => v) && (
        ...
        >
          <View style={styles.priceHeader}>
            <View>
              ...
              >{`$${reservation.totalPrice.toFixed(2)}`}</Text>
            </View>
            ...
            <View style={styles.priceBreakdown}>
              ...
              {priceBreakdown.deliveryFee && priceBreakdown.deliveryFee > 0 && (
                <View style={styles.breakdownRow}>
                  ...
                  >{`$${priceBreakdown.deliveryFee.toFixed(2)}`}</Text>
                </View>
              )}
              {priceBreakdown.extrasTotal && priceBreakdown.extrasTotal > 0 && (
                <View style={styles.breakdownRow}>
                  ...
                  <Text
                    style={styles.breakdownValue}
                  >{`$${priceBreakdown.extrasTotal.toFixed(2)}`}</Text>
                </View>
              )}
          ...
          <View style={styles.actionsSection}>
            ...
            {onViewDetails && (
              ...
              >
                ...
                <Text style={[styles.actionButtonText, { color: "#0B729D" }]}>
