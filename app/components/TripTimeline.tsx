...
export default function TripTimeline({
  ...
  const getSteps = (): TimelineStep[] => {
    ...
    if (currentStatus === "pending") {
      ...
      (currentStatus === "confirmed" && checkInCompleted) ||
    ...
    return [
      {
        ...
        description:
          currentStatus === "pending" ? "Esperando confirmación" : undefined,
      },
      {
        id: "confirmed",
        ...
        description:
          currentStep === 1 ? "Esperando fecha de inicio" : undefined,
      },
      {
        id: "check-in",
...
const styles = StyleSheet.create({
  ...
  connectingLine: {
    ...
    height: 20,
    marginLeft: 17,
    // No negative margins — they clip circles on Android
  },
});
