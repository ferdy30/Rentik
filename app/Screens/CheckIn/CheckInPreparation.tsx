...
export default function CheckInPreparation() {
  ...
  const handleContinue = () => {
    ...
    navigation.navigate("CheckInProcessExplanation", {
      reservation,
      isArrendador,
    });
  };
  ...
  const importantInfo = [
    ...
    },
    {
      ...
      value: reservation.isDelivery
        ? reservation.deliveryAddress
        : reservation.pickupLocation || "Ver ubicación",
      color: "#10B981",
    },
    {
            ...
            {isArrendador ? (
              <>
                <View style={styles.tipItem}>
                  ...
                  <Text style={styles.tipText}>
                    Ten a la mano el contrato digital
                  </Text>
                </View>
                <View style={styles.tipItem}>
                  <View style={styles.tipBullet} />
                  <Text style={styles.tipText}>
                    Verifica la identidad del conductor
                  </Text>
                </View>
                <View style={styles.tipItem}>
                  <View style={styles.tipBullet} />
                  <Text style={styles.tipText}>
                    Toma fotos claras de los 4 lados
                  </Text>
                </View>
              </>
            ) : (
              <>
                ...
                <View style={styles.tipItem}>
                  <View style={styles.tipBullet} />
                  <Text style={styles.tipText}>
                    Revisa el nivel de combustible al inicio
                  </Text>
                </View>
                <View style={styles.tipItem}>
                  <View style={styles.tipBullet} />
                  <Text style={styles.tipText}>
                    Toma fotos de cualquier daño existente
                  </Text>
                </View>
                <View style={styles.tipItem}>
                  <View style={styles.tipBullet} />
                  <Text style={styles.tipText}>
                    Verifica que todos los accesorios estén presentes
                  </Text>
                </View>
              </>
            )}
        ...
        <View style={styles.quickActions}>
          ...
          >
            ...
            <Text style={styles.quickActionText}>
              Chat con {isArrendador ? "el viajero" : "anfitrión"}
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.quickActionButton}
