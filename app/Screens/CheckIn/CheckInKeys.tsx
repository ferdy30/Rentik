  ...
  const handleContinue = async () => {
    try {
      ...
      await saveCheckInKeys(checkInId, {
        count: keysCount,
        working: keysWorking,
        // handoverCode removed
      });

      navigation.navigate("CheckInSignature", { 
        reservation: {
          id: reservation.id,
      ...
      logger.error("Error saving keys info", { error: error.message });
        ...
        >
          ...
          <View style={[styles.toggle, keysWorking && styles.toggleActive]}>
            <View
              style={[
                styles.toggleThumb,
                keysWorking && styles.toggleThumbActive,
              ]}
            />
          </View>
        </TouchableOpacity>

        {/* Code container removed */}
      </View>
