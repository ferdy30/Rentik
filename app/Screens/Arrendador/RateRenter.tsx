        ...
        try {
            ...
            await runTransaction(db, async (transaction) => {
                ...
                transaction.set(reviewRef, {
                    ...
                    hostId: user?.uid,
                    authorId: user?.uid,
                    authorName: user?.nombre || 'Host',
                    rating,
                    comment: comment.trim(),
                    createdAt: serverTimestamp(),
                    type: 'host_to_renter', // Type of review
                    visible: true,
                });
            ...
            if (error.code === 'permission-denied') {
                ...
                Alert.alert(
                    'Error',
                    'El arrendatario no fue encontrado.',
            ...
            >
                <View style={styles.header}>
                    <Text style={styles.title}>
                        ¿Cómo fue tu experiencia con {reservation.renterSnapshot?.nombre || 'el arrendatario'}?
                    </Text>
