            ...
            <ScrollView style={styles.content} contentContainerStyle={{ paddingBottom: 120 }}>
                <View style={styles.instructionsCard}>
                    ...
                    <Text style={styles.instructionsText}>
                        Es importante documentar el estado final del veh�culo para evitar cargos injustificados y liberar tu fianza.
                    </Text>
                </View>
                ...
                {completedCount < totalCount && (
                    <View style={{ 
                        ...
                        <Text style={{ flex: 1, fontSize: 12, color: '#92400E', fontFamily: typography.fonts.semiBold }}>
                            Faltan {totalCount - completedCount} fotos. Puedes continuar de todas formas.
                        </Text>
                    </View>
                )}
            </View>
