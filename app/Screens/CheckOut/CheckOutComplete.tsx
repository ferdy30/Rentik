    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.content}>
                ...
                <Text style={styles.title}>�Devoluci�n Exitosa!</Text>
                <Text style={styles.subtitle}>
                    Has completado el proceso de devoluci�n correctamente.
                </Text>
                ...
                <View style={styles.card}>
                    ...
                    <View style={styles.stepRow}>
                        ...
                        <View style={styles.stepContent}>
                            ...
                            <Text style={styles.stepDesc}>
                                Se ha enviado un resumen de la devoluci�n a tu correo electr�nico.
                            </Text>
                        </View>
                    </View>
                </View>
